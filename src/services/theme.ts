...
export function readGraphPalette() {
  return {
    ...
    link: readThemeColor('--graph-link', 'rgba(111, 137, 112, 0.72)'),
    linkDim: readThemeColor('--graph-link-dim', 'rgba(111, 137, 112, 0.28)'),
    tagLink: readThemeColor('--graph-tag-link', 'rgba(176, 146, 81, 0.7)'),
    tagLinkDim: readThemeColor('--graph-tag-link-dim', 'rgba(176, 146, 81, 0.28)'),
